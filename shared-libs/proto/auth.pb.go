...
type RegisterRequest struct {
	...
	Role          string                 `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"` // Ensure this field exists
...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Change 'UserId' to 'user_id' to match protobuf conventions
...
var file_auth_proto_rawDesc = string([]byte{
	...
	0x67, 0x65, 0x32, 0xbb, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c, 0x6f, 0x67,
	...
	0x64, 0x69, 0x74, 0x79, 0x61, 0x2d, 0x50, 0x53, 0x2d, 0x30, 0x35, 0x2f, 0x4e, 0x65, 0x65, 0x74,
	0x43, 0x68, 0x61, 0x6d, 0x70, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2d, 0x6c, 0x69, 0x62,
...
var file_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.LogoutUser:input_type -> auth.LogoutRequest
	...
	5, // 5: auth.AuthService.LogoutUser:output_type -> auth.LogoutResponse
